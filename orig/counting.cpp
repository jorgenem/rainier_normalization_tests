{
   ...
   TH2F *h = new TH2F("h"," ",10,-0.840000,7.800000,50,4.400223,187140064.000000);
   ...
   float Bn[1]={7.359200};
   float Bnerr[1]={0.001};
   float rho_Bn[1]={14875000.000000};
   ...
   fermicalc->DrawGraph(31,&fermicalc->GetX()[42],&fermicalc->GetY()[42],"L");
   ...
   TLatex t;
   t.SetTextSize(0.05);
   t.DrawLatex(    6.240,9.357e+07,"^{xx}Yy");
   TArrow *arrow1 = new TArrow(0.600000,1709.032093,0.600000,260.318207,0.02,">");
   arrow1->Draw();
   TArrow *arrow2 = new TArrow(1.560000,10293.629629,1.560000,1567.916260,0.02,">");
   arrow2->Draw();
   TArrow *arrow3 = new TArrow(5.040000,8838733.922220,5.040000,1346307.875000,0.02,">");
   arrow3->Draw();
   TArrow *arrow4 = new TArrow(5.880000,80684353.479759,5.880000,12289767.000000,0.02,">");
   arrow4->Draw();
   c1->Update();
