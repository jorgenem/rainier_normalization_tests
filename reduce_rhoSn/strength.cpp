{
	...
	TH2F *h = new TH2F("h"," ",10,0.0,   8.060,10,6.976e-10,7.812e-07);
	ifstream strengthfile("strength.nrm");
	float strength[72],strengtherr[72],energyerr[72];
	float energy[711],trans[711];
	int i = 0;
   float a0 =  -0.8400;
   float a1 =   0.1200;
	float x;	
	...
	TGraphErrors *strengthexp = new TGraphErrors(72,energy,strength,energyerr,strengtherr);
    i = 0;
	...
	TLatex t;
	t.SetTextSize(0.05);
	t.DrawLatex(    1.512,2.344e-07,"^{xx}Yy");
	c1->Update();
